; ModuleID = 'tests-alunos/minijava/golden/LinkedList.dce.bc'
...
entry0:
  ...
  %tmp3 = bitcast %class.List* %tmp0 to %class.List*
...
entry0:
  ...
  store %class.List* %v_next, %class.List** %tmp1
  ret i1 true
}
...
then13:                                           ; preds = %cont8
  ...
  %tmp39 = bitcast %class.List* %tmp37 to %class.List*
...
cont5:                                            ; preds = %else6, %then4
  ...
  %tmp14 = bitcast %class.List* %tmp12 to %class.List*
...
do1:                                              ; preds = %while3
  ...
  %tmp15 = bitcast %class.List* %tmp13 to %class.List*
...
entry0:
  ...
  %tmp7 = bitcast %class.List* %tmp5 to %class.List*
  ...
  %tmp15 = bitcast %class.Element* %tmp12 to %class.Element*
  ...
  %tmp22 = bitcast %class.List* %tmp20 to %class.List*
  ...
  %tmp29 = bitcast %class.Element* %tmp26 to %class.Element*
  ...
  %tmp37 = bitcast %class.List* %tmp35 to %class.List*
  ...
  %tmp44 = bitcast %class.Element* %tmp41 to %class.Element*
  ...
  %tmp51 = bitcast %class.List* %tmp49 to %class.List*
  ...
  %tmp56 = bitcast %class.Element* %tmp53 to %class.Element*
  ...
  %tmp75 = bitcast %class.Element* %tmp72 to %class.Element*
  ...
  %tmp82 = bitcast %class.List* %tmp80 to %class.List*
  ...
  %tmp91 = bitcast %class.List* %tmp89 to %class.List*
  ...
  %tmp100 = bitcast %class.List* %tmp98 to %class.List*
